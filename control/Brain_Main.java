...
public class Brain_Main {
    ...
    API api;
    Brain_Bygninger brain_Bygninger;
    ...
    int Population = 50;
    int Bygningsantall;
    public Brain_Main(API api) {
	// System.out.println("hmz2");
	this.api = api;
	brain_Bygninger = new Brain_Bygninger(api);
	SettOppResursser();
	SettOppLand();
	...
	if (LandNumber == 1) {
	    ...
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[11].HentNavn());
	} else if (LandNumber <= 3) {
	    Array_Land[9].SettStorage(Array_Land[9].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[9].HentNavn());
	} else if (LandNumber <= 7) {
	    Array_Land[10].SettStorage(Array_Land[10].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[10].HentNavn());
	} else if (LandNumber <= 15) {
	    Array_Land[5].SettStorage(Array_Land[5].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[5].HentNavn());
	} else if (LandNumber <= 31) {
	    Array_Land[8].SettStorage(Array_Land[8].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[8].HentNavn());
	} else if (LandNumber <= 47) {
	    Array_Land[7].SettStorage(Array_Land[7].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[7].HentNavn());
	} else if (LandNumber <= 63) {
	    Array_Land[1].SettStorage(Array_Land[1].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[1].HentNavn());
	} else if (LandNumber <= 87) {
	    Array_Land[6].SettStorage(Array_Land[6].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[6].HentNavn());
	} else if (LandNumber <= 119) {
	    Array_Land[12].SettStorage(Array_Land[12].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[12].HentNavn());
	} else if (LandNumber <= 151) {
	    Array_Land[2].SettStorage(Array_Land[2].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[2].HentNavn());
	} else if (LandNumber <= 183) {
	    Array_Land[4].SettStorage(Array_Land[4].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[4].HentNavn());
	} else if (LandNumber <= 231) {
	    Array_Land[3].SettStorage(Array_Land[3].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[3].HentNavn());
	} else if (LandNumber <= 347) {
	    Array_Land[0].SettStorage(Array_Land[0].HentStorage() + 1);
	    api.GUI_LabelUpdate_Expedition("Expedition has found " + Array_Land[0].HentNavn());
	} else {}
	/*
