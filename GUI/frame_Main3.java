...
public class frame_Main3 extends JFrame implements ActionListener {
	...
	/*
	 * Tekst1 = new JLabel("Liste over bygninger her"); c.gridx = 2; c.gridy = 13; c.gridwidth = 2; pane.add(Tekst1, c);
	 */
	...
	/*
	 * SpringUtilities.makeCompactGrid(pane, //parent 3, 3, //rows, collumns 3, 3, //initX, initY 3, 3); //xPad, yPad
	 */
	int x = 2;
