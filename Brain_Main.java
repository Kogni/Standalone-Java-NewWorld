...
public class Brain_Main {
	...
	private GUI_Main2 Class_GUI_Main2;
	...
	public Brain_Main(){
		...
		SettOppGUI();
		Brain_Resources Class_Brain_Resources = new Brain_Resources();
		Timeren();
	}
	...
	public void SettOppByggTyper(){
		Object_BuildingType Object_StoneCutter = new Object_BuildingType("Stone Cutter","Here your workers can get stone for your settlement. Stone is needed for making bricks, which is needed for building any building. You NEED this building.", null, null, Array_Land[2], Array_Resources[0], 0.5 );
		Array_ByggTyper[0] = Object_StoneCutter;
		Object_BuildingType Object_Quarry = new Object_BuildingType("Quarry", "Here you can get bricks for your settlement. Bricks are needed for building any building. You NEED this building.", Array_Resources[0], null, Array_Land[0], Array_Resources[1], 0.5);
		Array_ByggTyper[1] = Object_Quarry;
		Object_BuildingType Object_WoodCutter = new Object_BuildingType("Wood Cutter", "Here your workers can get wood for your settlement. Wood is needed for making lumber, which is needed for building any building. You NEED this building.", null, null, Array_Land[3], Array_Resources[2], 0.5);
		Array_ByggTyper[2] = Object_WoodCutter;
		Object_BuildingType Object_LumberMill = new Object_BuildingType("Lumber Mill", "Here you can get lumber for your settlement. Bricks are needed for building any building. You NEED this building.", Array_Resources[2], null, Array_Land[0], Array_Resources[3], 0.5);
		Array_ByggTyper[3] = Object_LumberMill;
		Object_BuildingType Object_Weaponry = new Object_BuildingType("Weaponry", "An armoursmith will make guns from ironbars, which can be used for defending and attacking or sold in Europe.", Array_Resources[5], Array_Resources[6], Array_Land[0], Array_Resources[8], 1);
		Array_ByggTyper[4] = Object_Weaponry;
		Object_BuildingType Object_ToolMaker = new Object_BuildingType("Tool Maker", "A toolmaker will turn iron into tools. Tools are needed for building any building, and with a toolmaker you dont have to buy all the tools from Europe.", Array_Resources[5], Array_Resources[6], Array_Land[0], Array_Resources[7], 1);
		Array_ByggTyper[5] = Object_ToolMaker;
		Object_BuildingType Object_CopperMine = new Object_BuildingType("Copper Mine", "Copper and tin can be used to make bronze, which you can sell in Europe", null, null, Array_Land[6], Array_Resources[9], 1);
		Array_ByggTyper[6] = Object_CopperMine;
		Object_BuildingType Object_TinMine = new Object_BuildingType("Tin Mine", "Copper and tin can be used to make bronze, which you can sell in Europe", null, null, Array_Land[7], Array_Resources[10], 1);
		Array_ByggTyper[7] = Object_TinMine;
		Object_BuildingType Object_BronzeWorks = new Object_BuildingType("Bronze Works", "With a supply of copper and tin, you can smelt them into bronze, which you can sell in Europe", Array_Resources[9], Array_Resources[10], Array_Land[0], Array_Resources[11], 1);
		Array_ByggTyper[8] = Object_BronzeWorks;
		Object_BuildingType Object_CoalMine = new Object_BuildingType("Coal Mine", "Coal and Iron is used to make weapons and tools", null, null, Array_Land[8], Array_Resources[6], 2);
		Array_ByggTyper[9] = Object_CoalMine;
		Object_BuildingType Object_IronMine = new Object_BuildingType("Iron Mine", "An iron mine is a good investment. Iron can be melted into tools, which you need to build any building. With an iron mine and a tool maker, you dont have to buy tools from Europe.", null, null, Array_Land[5], Array_Resources[4], 1);
		Array_ByggTyper[10] = Object_IronMine;
		Object_BuildingType Object_IronWorks = new Object_BuildingType("Iron Works", "With a supply of iron and coal, you can smelt them into iron bars, which you can make guns and tools from.", Array_Resources[4], Array_Resources[6], Array_Land[0], Array_Resources[5], 1);
		Array_ByggTyper[11] = Object_IronWorks;
		Object_BuildingType Object_SheepRanch = new Object_BuildingType("Sheep Ranch", "Wool is used to make cloth", null, null, Array_Land[0], Array_Resources[12], 1);
		Array_ByggTyper[12] = Object_SheepRanch;
		Object_BuildingType Object_WeaversHouse = new Object_BuildingType("Weaver's House", "Cloth is made from wool, and can be sold in Europe", Array_Resources[12], null, Array_Land[0], Array_Resources[13], 1);
		Array_ByggTyper[13] = Object_WeaversHouse;
		Object_BuildingType Object_HuntersLodge = new Object_BuildingType("Hunter's Lodge", "Meat can bea eaten by your population or sold in Europe", null, null, Array_Land[3], Array_Resources[14], 0.5);
		Array_ByggTyper[14] = Object_HuntersLodge;
		Object_BuildingType Object_Fisherhut = new Object_BuildingType("Fisherhut", "Fish can bea eaten by your population or sold in Europe", null, null, Array_Land[4], Array_Resources[15], 0.5);
		Array_ByggTyper[15] = Object_Fisherhut;
		Object_BuildingType Object_Farm = new Object_BuildingType("Farm", "Vegetables can bea eaten by your population or sold in Europe", null, null, Array_Land[0], Array_Resources[16], 0.5);
		Array_ByggTyper[16] = Object_Farm;
		Object_BuildingType Object_Stables = new Object_BuildingType("Stables", "Stables will make your horses reproduce at a slow rate. Horses can be sold or used by your soldiers to fight.", null, null, Array_Land[0], Array_Resources[17], 1);
		Array_ByggTyper[17] = Object_Stables;
		Object_BuildingType Object_PetHuntersLodge = new Object_BuildingType("Pet Hunter's Lodge", "The new world is filled with exotic animals, and the rich people in Europe are certain to want one of them.", null, null, Array_Land[3], Array_Resources[19], 0.6);
		Array_ByggTyper[18] = Object_PetHuntersLodge;
		Object_BuildingType Object_SlaveMarket = new Object_BuildingType("Slave Market", "Slaves can be sold in Europe", null, null, Array_Land[12], Array_Resources[20], 0.4);
		Array_ByggTyper[19] = Object_SlaveMarket;
		Object_BuildingType Object_SpicePlantation = new Object_BuildingType("Spice Plantation", "Spices can be sold in Europe", null, null, Array_Land[1], Array_Resources[18], 0.5);
		Array_ByggTyper[20] = Object_SpicePlantation;
		Object_BuildingType Object_SilverMine = new Object_BuildingType("Silver Mine", "Silver can be sold in Europe", null, null, Array_Land[10], Array_Resources[21], 0.3);
		Array_ByggTyper[21] = Object_SilverMine;
		Object_BuildingType Object_GoldMine = new Object_BuildingType("Gold Mine", "Gold can be sold in Europe", null, null, Array_Land[9], Array_Resources[22], 0.2);
		Array_ByggTyper[22] = Object_GoldMine;
		Object_BuildingType Object_GemMine = new Object_BuildingType("Gem Mine", "Gems can be sold in Europe", null, null, Array_Land[11], Array_Resources[23], 0.1);
		Array_ByggTyper[23] = Object_GemMine;
		Object_BuildingType Object_Warehouse = new Object_BuildingType("Warehouse", "Upgrade to increase your maximum resource count.", null, null, Array_Land[0], null, 0);
	...
	public void SettOppGUI (){
		//System.out.println("hmz3");
		//GUI_Main Class_GUI_Main = new GUI_Main();
		//Class_GUI_Main.SettOpp(Array_Resources, Array_Land, Array_ByggTyper);
		
		Class_GUI_Main2 = new GUI_Main2();
		...
		//GUI_Main3 Class_GUI_Main3 = new GUI_Main3();
		//Class_GUI_Main3.SettOpp(Array_Resources, Array_Land, Array_ByggTyper, Array_Bygg);
		
		//TinyGUI TinyGUI2 = new TinyGUI();
		//TinyGUI2.SettOpp(Array_Resources, Array_Land, Array_ByggTyper, Array_Bygg);
		
		//Class_GUI_Main.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
		Class_GUI_Main2.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
		//Class_GUI_Main3.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
		//TinyGUI2.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
	}
	...
	public void SettProduksjon(){
	    ...
	    for ( int x = 0 ; x < Bygningsantall+1 ; x++ ) {
	    	if (Array_Bygg[x].Level > 0){
	    		...
	    		//100/4 * 1 = 25
	    		//System.out.println((Population/Arbeidsplasser)*Array_Bygg[x].Level);
	    		
	    		//(1 *(100/2))/2 = 50/2=25
//	    		(1 *(160/2))/2 = 80/2=40
	    		/*
	    		if ( Factor > (Arbeidsplasser*5)){
	    			Factor = (Arbeidsplasser*5);
	    		}
	    		*/
	    		//System.out.println(Factor + " " + Array_Bygg[x].Level + " " + Population + " " + Arbeidsplasser);
	    		...
	    		//Array_Bygg[x].Production = (int)(5 * (Math.pow(1.5,(Array_Bygg[x].Level-1))));
	    		//Array_Bygg[x].Production = (int)Factor;
	    		
	    		Array_Bygg[x].Production = (int)(5 * (Math.pow(1.5,(Array_Bygg[x].Level-1))));
	    		
	    		MaxProduction = (int)((Array_Bygg[x].Production + Array_Bygg[x].Level*5) * Array_Bygg[x].Factor);
	    		//System.out.println(Array_Bygg[x].BygningsNavn + " " + MaxProduction);
	    		//System.out.println(Array_Bygg[x].BygningsNavn + " " + ((Array_Bygg[x].Production+Factor) * Array_Bygg[x].Factor));
	    		//System.out.println(Array_Bygg[x].BygningsNavn + " " + (Array_Bygg[x].Production * Array_Bygg[x].Factor));
	    		...
	    		/*
	    		if ( Array_Bygg[x].BygningsNavn == "Coal Mine" ){
	    			Array_Bygg[x].Production = Array_Bygg[x].Production * 2;
	    		}
	    		*/
	    	}
	    }
			...
			if ( Array_Bygg[x].HentLevel() > 0){
				...
				if ( Array_Bygg[x].Raw1 == null){
					...
					if  ( Array_Bygg[x].Product != null){
						...
						//System.out.println(Array_Bygg[x].BygningsNavn + " " + NyttAntall);
						//Array_Bygg[x].Product.ResourceStorage = Array_Bygg[x].Product.ResourceStorage +Array_Bygg[x].Product.Production;
						//System.out.println(x + " " + Array_Bygg[0].Product.ResourceName + " " + Array_Bygg[0].Product.ResourceStorage);
					}
				}
			}
		}
					...
					if ( Array_Bygg[x].Raw1 != null){
						...
						if ( Array_Bygg[x].Raw2 == null){ //krever bare 1 råvare
							if (Array_Bygg[x].Raw1.ResourceStorage >=  Array_Bygg[x].Production){ //det er nok råvarer
								//System.out.println("nok råvarer " + Array_Bygg[x].Raw1.ResourceStorage + " " + Array_Bygg[x].Raw1.ResourceName);
								...
								//System.out.println(Array_Bygg[x].Product.ResourceName + " " + Array_Bygg[x].Product.Production + " " + MaxProduce + " " + Array_Bygg[x].Raw1.ResourceStorage);
							}
							...
							//System.out.println("Produserer " + Array_Bygg[x].Product.ResourceName + " fra " + Array_Bygg[x].Raw1.ResourceName + " og " + Array_Bygg[x].Raw2.ResourceName);
	...
	public void Befolkningsvekst(){
		...
		int MatTilgjengelig = Array_Resources[14].ResourceStorage + Array_Resources[15].ResourceStorage + Array_Resources[16].ResourceStorage;
		...
		if ( MatProduksjon > 0 ){
			System.out.println("a");
			if ( MatProduksjon > Rasjon){
				System.out.println("b");
				NyBefolkning = NyBefolkning + ((MatProduksjon-Rasjon)/5)+1;
			} else if ( MatProduksjon == Rasjon){
				System.out.println("c");
			} else {
		...
		*/
		...
		/*
		if ( MatProduksjon > 0 ){
			if ( Rasjon < (MatProduksjon+1)) { //produserer mer mat enn det trengs, befolkning øker med (Rasjon/5)+1
				//(636/10) = 60
				//trekk fra alt som produseres, pluss 1 til.
				NyBefolkning = NyBefolkning + ((MatProduksjon-Rasjon)/5)+1;

				/*
				if ( MatTilgjengelig >= Rasjon){
					NyBefolkning = NyBefolkning + (Rasjon/5);
					//(50/10)/10 = 5/10 = 0,5 = 0 = 1
					//(150/10)/10 = 15/10 = 1,5 = 1
					//(150/5)/10 = 15/5 =3
				}
				if ( NyBefolkning == Population){
					NyBefolkning = Population + 1;
				}
				...
				//System.out.println("Befolkningen øker fra " + Population + " til " + NyBefolkning);
				Class_GUI_Main2.PopulationTekst.setText("Befolkningen øker med " + (NyBefolkning-Population));
			}
		} else if ( Rasjon == MatProduksjon) {
			for ( int x = 0 ; x < (Rasjon) ; x++ ) {
				System.out.println("b");
				if ( Array_Resources[14].ResourceStorage > 0 ){
					Array_Resources[14].ResourceStorage = Array_Resources[14].ResourceStorage -1;
		...
		} else if ( MatProduksjon == 0 ) {
			System.out.println("MatTilgjengelig=" + MatTilgjengelig + " Rasjon=" + Rasjon);
			if ( MatTilgjengelig > Rasjon){ //nok lagret mat
				System.out.println("a");
				NyBefolkning = Population + 1;
				for ( int x = 0 ; x < (Rasjon) ; x++ ) {
					if ( Array_Resources[14].ResourceStorage > 0 ){
				...
				Class_GUI_Main2.PopulationTekst.setText("Befolkningen øker med 1");
			} else if ( MatTilgjengelig == Rasjon){  //akkurat nok mat
				System.out.println("c");
				//NyBefolkning = NyBefolkning + ((MatTilgjengelig-Rasjon)/2);
				//((7-7)/2
				Class_GUI_Main2.PopulationTekst.setText("");
				//Class_GUI_Main2.PopulationTekst.setText("Befolkningen synker med  med " + (NyBefolkning-Population));
				for ( int x = 0 ; x < (Rasjon) ; x++ ) {
					if ( Array_Resources[14].ResourceStorage > 0 ){
						Array_Resources[14].ResourceStorage = Array_Resources[14].ResourceStorage -1;
					} else if ( Array_Resources[15].ResourceStorage > 0 ){
			...
			} else { //for lite lagret mat
				System.out.println("c");
				NyBefolkning = Population+((Population * ((MatTilgjengelig-Rasjon)/Rasjon))/2);
				//40*((1-2)/2) = 
				//40*((0-2)/2) = 0
				System.out.println(Population + "+((" + Population + "*" + "((" + MatTilgjengelig + "-" + Rasjon + "))/2)");
				Class_GUI_Main2.PopulationTekst.setText("Befolkningen synker med  med " + (NyBefolkning-Population));
				Array_Resources[14].ResourceStorage = 0;
				Array_Resources[15].ResourceStorage = 0;
				Array_Resources[16].ResourceStorage = 0;
			...
			//la dem som kan få mat få det, av resten kan halvparten dø
			NyBefolkning = Population * (MatTilgjengelig/Rasjon);
			//636 + ((0-60)/100) = 636 -0,06
			//636+((0-60)/10) = 636-0,6
			//636+(0-60) = 636-60
			Array_Resources[14].ResourceStorage = 0;
			Array_Resources[15].ResourceStorage = 0;
			Array_Resources[16].ResourceStorage = 0;
			//System.out.println("Befolkningen synker fra " + Population + " til " + NyBefolkning);
			Class_GUI_Main2.PopulationTekst.setText("Befolkningen synker med " + (NyBefolkning-Population));
		}
		*/
